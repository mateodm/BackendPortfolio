...
import com.backend.portfolio.LogIn.Enum.Security.JWT.JwtEntryPoint;
import com.backend.portfolio.LogIn.Enum.Security.JWT.JwtTokenFilter;
...
public class MainSecurity  {
    ...
    @Autowired UserDetailsJWT userDetailsJWT;
